...
import com.grupo16.hackathon.exception.ExceptionJson;
...
public class ControllerExceptionHandlerConfiguration {
	...
	private static final String AUTH_EXCEPTION_HANDLER_ERROR_TO_RESOLVE_EXCEPTION = "hackathon.exceptionHandler.errorToResolveException";
	private static final String AUTH_ARGUMENT_NOT_VALID = "hackathon.argumentNotValid";
